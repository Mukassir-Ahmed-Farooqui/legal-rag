...
def test_documents_endpoint_isolated():
    ...
    # 2. Insert a dummy point to COLLECTION_SECTIONS
    dummy_doc_id = "test-doc-12345"
    dummy_filename = "test_document_mock.pdf"
    
    # We need a dummy vector of VECTOR_DIM (384)
    dummy_vector = [0.0] * 384
    
    # We insert into COLLECTION_SECTIONS
    q_client.upsert(
    ...
    response = client.delete(f"/api/v1/documents/{dummy_doc_id}")
    assert response.status_code == 200
